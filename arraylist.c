...
#define AL_INITIAL_VALUE  10 //reserved size
//___________________
...
ArrayList* al_newArrayList(void)
{
    ...
    if(this != NULL)
    {
        ...
        {
            free(this);//si no encuentra espacio para la lista de elementos
        }
    }
 ...
 *
 */
int al_add(ArrayList* this, void* pElement)//meter el elemento en el arraylist
{
    int returnAux = -1;
    void** aux;
    int flag=0;
    ...
    if(this!= NULL && pElement!= NULL)
    {
        ...
        {
            aux=(void**) realloc(this->pElements, sizeof(void*)*(this->reservedSize + AL_INCREMENT));//dentro del sizeof siempre es un asterisco menos de lo que tengo afuera
            if(aux!=NULL)
            {
                this-> pElements= aux;
        ...
        if(flag==0)
        {
                ...
                *(this-> pElements+this->size)= pElement;//artimetica de punteros
...
void* al_get(ArrayList* this, int index)
{
    ...
    if(this!= NULL)
    {
        if(index< this->len(this))//o al_len(this)
        {
...
int al_set(ArrayList* this, int index, void* pElement)
{
    ...
    if(this!= NULL && pElement!= NULL)
    {
        ...
        else if(index<(this->len(this)) && index>=0)
        {
    ...
    if(this!=NULL && from >=0 && to <= this->len(this) && from <to )
    {
        ...
        if(returnAux!=NULL)
        {
            for(int i=from; i<to; i++)
            {
                ...
                if(pElementAux==NULL || returnAux->add(returnAux ,pElementAux)!=0 )
                {
